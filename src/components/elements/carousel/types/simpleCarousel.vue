                ...
                <div class="back bg-center bg-cover" :style="(project.img)?('background-image: url('+project.img+')'):('bg-backgroundLight')">
                  <div class="h-full w-full bg-gray-600 bg-opacity-80 p-12">
                    ...
                    <div class="text-white text-base ">
                      ...
                      <p v-if="project.link">Click <a :href="project.link">here</a> to learn more!</p>
                      <p v-if="project.learnMore"><a :href="'./'+project.learnMore">Want to see more?</a></p>
                      <p v-if="project.goto"><a :href="project.goto">Go to {{project.name}}!</a></p>
                      <p v-if="project.github"><a :href="project.github">Go to code!</a></p>
