<template>
  <div id="navbar" class="navbar h-screen fixed w-32 bg-backgroundLight tablet:z-50 tablet:fixed tablet:w-screen tablet:h-screen tablet:border-none tablet:right-0 tablet:right-full tablet:bg-background tropacity">  
    <div class="p-2 tablet:top-1/3 tablet:left-1/2 tablet:-translate-1/2 absolute tablet:relative tablet:w-full tablet:max-w-logo">
      <img class="w-full h-full" :src="require('@/assets/logo.png')" alt="">
    </div>
