...
let br = false;
const points = [
    {name: 'TypeScript', x:0, y:0, z:0},
    {name: 'JavaScript', x:0, y:0, z:0},
    {name: 'Go', x:0, y:0, z:0},
    ...
    {name: 'Vue', x:0, y:0, z:0},
    {name: 'Node.js', x:0, y:0, z:0},
    {name: 'Spring Boot', x:0, y:0, z:0},
    {name: 'Three.js', x:0, y:0, z:0},
    {name: 'Tailwind CSS', x:0, y:0, z:0},
    {name: 'Docker', x:0, y:0, z:0},
    {name: 'AWS', x:0, y:0, z:0},
    {name: 'Linux', x:0, y:0, z:0},
    {name: 'Bash', x:0, y:0, z:0},
    {name: 'Git', x:0, y:0, z:0},
    {name: 'MySQL', x:0, y:0, z:0},
    {name: 'MongoDB', x:0, y:0, z:0},
    {name: 'Firebase', x:0, y:0, z:0},
    {name: 'ChromaDB', x:0, y:0, z:0},
    {name: 'RAG', x:0, y:0, z:0},
    {name: 'PyTorch', x:0, y:0, z:0},
    {name: 'Illustrator', x:0, y:0, z:0},
    {name: 'Photoshop', x:0, y:0, z:0},
    {name: 'After Effects', x:0, y:0, z:0},
]
